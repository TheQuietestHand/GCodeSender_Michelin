...
# Form implementation generated from reading ui file 'UI/v0.01_Main.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_14.addWidget(self.labelRuntimeVar, 1, 2, 1, 3)
        ...
        self.gridLayout_14.addWidget(self.labelLastStateVar, 4, 2, 1, 3)
        ...
        self.gridLayout_14.addWidget(self.labelRemainingTimeVar, 2, 2, 1, 3)
        ...
        self.gridLayout_14.addWidget(self.labelQueuedCommandsVar, 3, 2, 1, 3)
        ...
        self.gridLayout_12.addWidget(self.listViewCode, 0, 0, 9, 1)
        ...
        self.gridLayout_12.addWidget(self.labelCodeLines, 0, 1, 1, 1)
        self.label = QtWidgets.QLabel(self.tabCode)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.gridLayout_12.addWidget(self.labelStartFrom, 2, 1, 1, 1)
        ...
        self.gridLayout_12.addWidget(self.spinBoxStartFrom, 3, 1, 1, 1)
        ...
        self.gridLayout_12.addWidget(self.labelStartFrom_2, 4, 1, 1, 1)
        ...
        self.gridLayout_12.addWidget(self.spinBoxDoTo, 5, 1, 1, 1)
        ...
        self.gridLayout_12.addWidget(self.labelPeriod, 6, 1, 1, 1)
        ...
        self.gridLayout_12.addWidget(self.spinBoxPeriod, 7, 1, 1, 1)
        ...
        self.gridLayout_12.addWidget(self.pushButtonRunCode, 8, 1, 1, 1)
        ...
        self.listWidget = QtWidgets.QListWidget(self.tabConsole)
        self.listWidget.setObjectName("listWidget")
        self.gridLayout_13.addWidget(self.listWidget, 0, 0, 11, 1)
        self.label_2 = QtWidgets.QLabel(self.tabConsole)
        self.label_2.setAlignment(QtCore.Qt.AlignCenter)
        self.label_2.setObjectName("label_2")
        self.gridLayout_13.addWidget(self.label_2, 0, 1, 1, 2)
        self.pushButtonGrblHelp = QtWidgets.QPushButton(self.tabConsole)
        self.pushButtonGrblHelp.setEnabled(False)
        self.pushButtonGrblHelp.setObjectName("pushButtonGrblHelp")
        self.gridLayout_13.addWidget(self.pushButtonGrblHelp, 1, 2, 1, 1)
        self.pushButtonGrblSettings = QtWidgets.QPushButton(self.tabConsole)
        self.pushButtonGrblSettings.setEnabled(False)
        self.pushButtonGrblSettings.setObjectName("pushButtonGrblSettings")
        self.gridLayout_13.addWidget(self.pushButtonGrblSettings, 2, 2, 1, 1)
        self.pushButtonGrblParameters = QtWidgets.QPushButton(self.tabConsole)
        self.pushButtonGrblParameters.setEnabled(False)
        self.pushButtonGrblParameters.setObjectName("pushButtonGrblParameters")
        self.gridLayout_13.addWidget(self.pushButtonGrblParameters, 3, 2, 1, 1)
        self.pushButtonGrblParserState = QtWidgets.QPushButton(self.tabConsole)
        self.pushButtonGrblParserState.setEnabled(False)
        self.pushButtonGrblParserState.setObjectName("pushButtonGrblParserState")
        self.gridLayout_13.addWidget(self.pushButtonGrblParserState, 4, 2, 1, 1)
        self.pushButtonGrblBuildInfo = QtWidgets.QPushButton(self.tabConsole)
        self.pushButtonGrblBuildInfo.setEnabled(False)
        self.pushButtonGrblBuildInfo.setObjectName("pushButtonGrblBuildInfo")
        self.gridLayout_13.addWidget(self.pushButtonGrblBuildInfo, 5, 2, 1, 1)
        self.pushButtonGrblStartupBlocks = QtWidgets.QPushButton(self.tabConsole)
        self.pushButtonGrblStartupBlocks.setEnabled(False)
        self.pushButtonGrblStartupBlocks.setObjectName("pushButtonGrblStartupBlocks")
        self.gridLayout_13.addWidget(self.pushButtonGrblStartupBlocks, 6, 2, 1, 1)
        self.pushButtonGrblCheck = QtWidgets.QPushButton(self.tabConsole)
        self.pushButtonGrblCheck.setEnabled(False)
        self.pushButtonGrblCheck.setObjectName("pushButtonGrblCheck")
        self.gridLayout_13.addWidget(self.pushButtonGrblCheck, 7, 2, 1, 1)
        self.pushButtonGrblUnlock = QtWidgets.QPushButton(self.tabConsole)
        self.pushButtonGrblUnlock.setEnabled(False)
        self.pushButtonGrblUnlock.setObjectName("pushButtonGrblUnlock")
        self.gridLayout_13.addWidget(self.pushButtonGrblUnlock, 8, 2, 1, 1)
        self.pushButtonGrblHomingCycle = QtWidgets.QPushButton(self.tabConsole)
        self.pushButtonGrblHomingCycle.setEnabled(False)
        self.pushButtonGrblHomingCycle.setObjectName("pushButtonGrblHomingCycle")
        self.gridLayout_13.addWidget(self.pushButtonGrblHomingCycle, 9, 2, 1, 1)
        self.pushButtonGrblRefreshPos = QtWidgets.QPushButton(self.tabConsole)
        self.pushButtonGrblRefreshPos.setEnabled(False)
        self.pushButtonGrblRefreshPos.setObjectName("pushButtonGrblRefreshPos")
        self.gridLayout_13.addWidget(self.pushButtonGrblRefreshPos, 10, 2, 1, 1)
        ...
        self.listWidgetLogs = QtWidgets.QListWidget(self.groupBoxLogs)
        self.listWidgetLogs.setProperty("isWrapping", True)
        self.listWidgetLogs.setObjectName("listWidgetLogs")
        self.gridLayout_11.addWidget(self.listWidgetLogs, 0, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Grbl commands"))
        self.pushButtonGrblHelp.setText(_translate("MainWindow", "Help"))
        self.pushButtonGrblSettings.setText(_translate("MainWindow", "Grbl Settings"))
        self.pushButtonGrblParameters.setText(_translate("MainWindow", "Parameters"))
        self.pushButtonGrblParserState.setText(_translate("MainWindow", "Parser state"))
        self.pushButtonGrblBuildInfo.setText(_translate("MainWindow", "Build info"))
        self.pushButtonGrblStartupBlocks.setText(_translate("MainWindow", "Startup blocks"))
        self.pushButtonGrblCheck.setText(_translate("MainWindow", "Check"))
        self.pushButtonGrblUnlock.setText(_translate("MainWindow", "Unlock GRBL"))
        self.pushButtonGrblHomingCycle.setText(_translate("MainWindow", "Homing cycle"))
        self.pushButtonGrblRefreshPos.setText(_translate("MainWindow", "Refresh pos"))
